...
return [
    'modules' => [
        ...
        'Ecomteck_Core' => 1,
        'Ecomteck_DeliveryDate' => 1,
        'Ecomteck_OneStepCheckout' => 1,
        'Ecomteck_OneStepCheckoutCompatible' => 1,
        'Ecomteck_OrderComment' => 1,
        'Healthviet_Common' => 1,
        'Healthviet_Blog' => 1,
        'Healthviet_BuyNow' => 1,
        'Healthviet_Catalog' => 1,
        'Healthviet_Checkout' => 1,
        'Healthviet_Banner' => 1,
        'Healthviet_Customer' => 1,
        'Healthviet_CustomerFeedback' => 1,
        'Healthviet_Directory' => 1,
        'Healthviet_Doctor' => 1,
        'Magefan_Community' => 1,
        'Healthviet_PriceDecimal' => 1,
        'Healthviet_Review' => 1,
        'Healthviet_Rule' => 1,
        'Healthviet_Sales' => 1,
        'Healthviet_Shipping' => 1,
        'Healthviet_Sitemap' => 1,
        'Healthviet_SocialLogin' => 1,
        'Magefan_OgTags' => 1,
        'Healthviet_OgTags' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
