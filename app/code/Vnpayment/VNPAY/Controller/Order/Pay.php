...
class Pay extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $this->helper->writeLog('VNPAY Pay response: ' . json_encode($responseParams));
            ...
            if ($order->getId()) {
                if ($order->getStatus() != null) {
                    if ($vnpResponseCode == '00') {
                        ...
                        $this->messageManager->addError('Thanh toán qua VNPAY thất bại. ' . $this->getResponseDescription($vnpResponseCode));
    ...
    public function getResponseDescription($responseCode)
    {
        switch ($responseCode) {
            ...
            case "08":
                ...
                break;
            case "99":
                $result = "Có lỗi xảy ra trong quá trình thực hiện giao dịch";
                break;
            default:
