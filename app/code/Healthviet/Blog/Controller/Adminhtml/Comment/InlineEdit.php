...
namespace Healthviet\Blog\Controller\Adminhtml\Comment;

use Magento\Backend\App\Action\Context;
use Magento\Framework\Controller\Result\JsonFactory;
use Healthviet\Blog\Api\Data\CommentInterface;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($commentItems as $commentReceived) {
            /** @var \Healthviet\Blog\Model\Comment $comment */
     ...
     * @return $this
     */
    public function setCommentData(\Healthviet\Blog\Model\Comment $comment, array $extendedCommentData, array $commentData)
    {
    ...
    {
        return $this->_authorization->isAllowed('Healthviet_Blog::comment_save');
    }
}
