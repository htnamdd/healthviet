...
use Healthviet\Blog\Model\ResourceModel\Comment\CollectionFactory;
 ...
 * Class MassHide
 */
class RelatedCommentsHide  extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $this->messageManager->addSuccess(__('A total of %1 record(s) have been hidden.', $collection->getSize()));
