...
use Healthviet\Blog\Api\Data\PostInterface;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($postItems as $postReceived) {
            /** @var \Healthviet\Blog\Model\Post $post */
     ...
     * @return void
     */
    protected function validatePost(array $postData, \Healthviet\Blog\Model\Post $post, &$error, array &$messages)
    {
     ...
     * @return $this
     */
    public function setPostData(\Healthviet\Blog\Model\Post $post, array $extendedPostData, array $postData)
    {
