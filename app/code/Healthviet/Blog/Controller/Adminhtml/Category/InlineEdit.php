...
use Healthviet\Blog\Api\Data\CategoryInterface;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Healthviet\Blog\Model\CategoryFactory $categoryFactory
    ) {
    ...
    public function execute()
    {
        ...
        foreach ($categoryItems as $categoryReceived) {
            /** @var \Healthviet\Blog\Model\Category $category */
     ...
     * @return void
     */
    protected function validateCategory(array $categoryData, \Healthviet\Blog\Model\Category $category, &$error, array &$messages)
    {
     ...
     * @return $this
     */
    public function setCategoryData(\Healthviet\Blog\Model\Category $category, array $extendedCategoryData, array $categoryData)
    {
    ...
    {
        return $this->_authorization->isAllowed('Healthviet_Blog::category_save');
    }
}
