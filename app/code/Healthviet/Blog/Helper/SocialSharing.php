 ...
 * Data helper.
 */
class SocialSharing extends AbstractHelper
{
    /**
     * Enabled config path.
     */
    const XML_PATH_ENABLED = 'tm_blog/social_sharing/general/enabled';

    /**
     * AddThis profile id config path.
     */
    const XML_PATH_PROFILE_ID = 'tm_blog/social_sharing/general/profile_id';

    /**
     * Icons style config path.
     */
    const XML_PATH_STYLE = 'tm_blog/social_sharing/look_and_feel/style';

    /**
     * Custom button image config path.
     */
    const XML_PATH_CUSTOM_BUTTON = 'tm_blog/social_sharing/look_and_feel/custom_button';

    /**
     * Custom buttons code config path.
     */
    const XML_PATH_CUSTOM_CODE = 'tm_blog/social_sharing/look_and_feel/custom_code';

    /**
     * Custom metadata config path.
     */
    const XML_PATH_CUSTOM_METADATA = 'tm_blog/social_sharing/custom_metadata';

    /**
     * Custom service config option.
     */
    const XML_PATH_CUSTOM_SERVICE = 'tm_blog/social_sharing/custom_service';

    /**
     * Exclude services config path.
     */
    const XML_PATH_EXCLUDE_SERVICES = 'tm_blog/social_sharing/api/exclude_services';

    /**
     * Compact menu services config path.
     */
    const XML_PATH_COMPACT_MENU_SERVICES = 'tm_blog/social_sharing/api/compact_menu_services';

    /**
     * Expanded menu services config path.
     */
    const XML_PATH_EXPANDED_MENU_SERVICES = 'tm_blog/social_sharing/api/expanded_menu_services';

    /**
     * Compact menu hover config path.
     */
    const XML_PATH_COMPACT_MENU_HOVER = 'tm_blog/social_sharing/api/compact_menu_hover';

    /**
     * Delay config path.
     */
    const XML_PATH_DELAY = 'tm_blog/social_sharing/api/delay';

    /**
     * Compact menu direction config path.
     */
    const XML_PATH_COMPACT_MENU_DIRECTION = 'tm_blog/social_sharing/api/compact_menu_direction';

    /**
     * New window config path.
     */
    const XML_PATH_NEW_WINDOW = 'tm_blog/social_sharing/api/new_window';

    /**
     * Menu language config path.
     */
    const XML_PATH_MENU_LANGUAGE = 'tm_blog/social_sharing/api/menu_language';

    /**
     * Offset top config path.
     */
    const XML_PATH_OFFSET_TOP = 'tm_blog/social_sharing/api/offset_top';

    /**
     * Offset left config path.
     */
    const XML_PATH_OFFSET_LEFT = 'tm_blog/social_sharing/api/offset_left';

    /**
     * Load AddThis config path.
     */
    const XML_PATH_LOAD_ADDTHIS_CSS = 'tm_blog/social_sharing/api/load_addthis_css';

    /**
     * Track clickbacks config path.
     */
    const XML_PATH_TRACK_CLICKBACKS = 'tm_blog/social_sharing/api/track_clickbacks';

    /**
     * Google analytics id config path.
     */
    const XML_PATH_GOOGLE_ANALYTICS_ID = 'tm_blog/social_sharing/api/google_analytics_id';
