<?php
namespace Healthviet\Blog\Block\Adminhtml\Category;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Initialize tm_blog category edit block
     *
     * @return void
     */
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Healthviet_Blog';
        $this->_controller = 'adminhtml_category';

        parent::_construct();

        if ($this->_isAllowedAction('Healthviet_Blog::category_save')) {
        ...
        if ($this->_isAllowedAction('Healthviet_Blog::category_delete')) {
    ...
    {
        if ($category = $this->_coreRegistry->registry('tm_blog_category')) {
            if ($category->getId()) {
