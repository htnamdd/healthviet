<?php
namespace Healthviet\Blog\Block\Adminhtml\Category\Edit\Tab;
...
class RelatedPosts extends Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function __construct(
        ...
        \Healthviet\Blog\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory,
        array $data = []
    ) {
    ...
    /**
     * Retrieve currently edited category model
     *
     * @return array|null
     */
    public function getCategory()
    {
        return $this->_coreRegistry->registry('tm_blog_category');
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'sortable' => false,
                'filter' => false,
                'header_css_class' => 'col-position no-display',
                'column_css_class' => 'col-position no-display'
            ]
        );
    ...
    {
        $posts = [];
        if ($postsR = $this->_coreRegistry->registry('tm_blog_category')->getRelatedPosts()) {
            foreach ($postsR as $post) {
                $posts[$post->getId()] = ['position' => ''];
            }
        }
        return $posts;
    }
