<?php
namespace Healthviet\Blog\Block\Adminhtml\Post\Edit\Tab;
...
class RelatedProducts extends Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        $products = [];
        if ($this->_coreRegistry->registry('tm_blog_post')->getRelatedProducts()) {
            foreach ($this->_coreRegistry->registry('tm_blog_post')->getRelatedProducts() as $product) {
