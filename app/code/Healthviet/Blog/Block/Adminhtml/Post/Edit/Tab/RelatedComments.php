...
class RelatedComments extends Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'header_css_class' => 'col-name',
                'column_css_class' => 'col-name',
                'renderer' => 'Healthviet\Blog\Block\Adminhtml\Post\Edit\Tab\Grid\Renderer\Edit',
                'filter' => false
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setTemplate('Healthviet_Blog::widget/grid/massaction_extended.phtml');
