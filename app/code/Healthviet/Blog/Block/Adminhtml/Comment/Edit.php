<?php
namespace Healthviet\Blog\Block\Adminhtml\Comment;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Healthviet_Blog::comment_save')) {
        ...
        if ($this->_isAllowedAction('Healthviet_Blog::comment_delete')) {
