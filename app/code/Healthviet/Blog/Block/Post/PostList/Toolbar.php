<?php
namespace Healthviet\Blog\Block\Post\PostList;

use \Magento\Framework\Registry;
use \Healthviet\Blog\Model\PostList\Toolbar as ToolbarModel;
use \Healthviet\Blog\Model\ResourceModel\Post\Collection;
use \Healthviet\Blog\Block\Post\PostList;
...
class Toolbar extends \Magento\Framework\View\Element\Template
{
    ...
    public function getCurrentDirection()
    {
        ...
        $directions = ['asc', 'desc' ];
        $direction = $this->_toolbarModel->getDirection() ? strtolower($this->_toolbarModel->getDirection()) : "";
