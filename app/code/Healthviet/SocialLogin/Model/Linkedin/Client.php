<?php
namespace Healthviet\SocialLogin\Model\Linkedin;
...
/**
 * Class Client
 * @package Healthviet\SocialLogin\Model\Linkedin
 */
class Client extends AbstractClient
{
    protected $redirect_uri_path  = 'sociallogin/linkedin/connect/';
    protected $path_enalbed='healthviet/linkedin/enabled';
    protected $path_client_id ='healthviet/linkedin/client_id';
    protected $path_client_secret = 'healthviet/linkedin/client_secret';
