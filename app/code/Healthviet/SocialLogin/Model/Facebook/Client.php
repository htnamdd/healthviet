<?php
namespace Healthviet\SocialLogin\Model\Facebook;
...
class Client extends AbstractClient
{
    ...
    protected $path_enalbed = 'healthviet/healthviet_fblogin_facebook/enabled';
    protected $path_client_id = 'healthviet/healthviet_fblogin_facebook/client_id';
    protected $path_client_secret = 'healthviet/healthviet_fblogin_facebook/client_secret';
