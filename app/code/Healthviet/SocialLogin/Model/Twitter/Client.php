<?php
namespace Healthviet\SocialLogin\Model\Twitter;
...
class Client
{
    ...
    const XML_PATH_ENABLED = 'healthviet/twitter/enabled';
    const XML_PATH_CLIENT_ID = 'healthviet/twitter/client_id';
    const XML_PATH_CLIENT_SECRET = 'healthviet/twitter/client_secret';
