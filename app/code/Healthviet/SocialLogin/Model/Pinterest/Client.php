<?php
namespace Healthviet\SocialLogin\Model\Pinterest;
...
/**
 * Class Client
 * @package Healthviet\SocialLogin\Model\Pinterest
 */
class Client extends AbstractClient
{

    protected $redirect_uri_path  = 'sociallogin/pinterest/connect/';
    protected $path_enalbed = 'healthviet/pinterest/enabled';
    protected $path_client_id = 'healthviet/pinterest/client_id';
    protected $path_client_secret = 'healthviet/pinterest/client_secret';
