<?php
namespace Healthviet\SocialLogin\Model\Google;
...
class Client extends AbstractClient
{
    ...
    protected $path_enalbed='healthviet/google/enabled';
    protected $path_client_id ='healthviet/google/client_id';
    protected $path_client_secret='healthviet/google/client_secret';
