...
/**
 * Class Connect
 * @package Healthviet\SocialLogin\Controller\Twitter
 */
class Connect extends \Magento\Framework\App\Action\Action
{
     ...
     * @param \Healthviet\SocialLogin\Model\Twitter\Client $client
     * @param \Healthviet\SocialLogin\Helper\SocialLogin $helper
     */
    public function __construct(
        \Magento\Framework\App\Action\Context $context,
        \Magento\Customer\Model\Session $customerSession,
        \Healthviet\SocialLogin\Model\Twitter\Client $client,
        \Healthviet\SocialLogin\Helper\SocialLogin $helper
    ) {
    ...
    protected function connect()
    {
        ...
        if ($customer->getId()) {
            $data = [
                ...
                'healthviet_sociallogin_type' => $twitter
            ];
