<?php
namespace Healthviet\SocialLogin\Controller\Linkedin;
...
class Connect extends AbstractConnect
{
     ...
     * @var string
     */
    protected $clientModel = '\Healthviet\SocialLogin\Model\Linkedin\Client';
        ...
        if ($code) {
            ...
            if ($customer->getId()) {
                $data = [
                    ...
                    'healthviet_sociallogin_type' => $linkedIn
                ];
