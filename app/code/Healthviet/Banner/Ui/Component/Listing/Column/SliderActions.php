...
class SliderActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    ...
    const URL_PATH_DELETE = 'healthviet_banner/slider/delete';
    const URL_PATH_DETAILS = 'healthviet_banner/slider/details';
    const URL_PATH_EDIT = 'healthviet_banner/slider/edit';
