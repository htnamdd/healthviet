            ...
            return Component.extend({
                ...
                useShippingAddress: function () {
                    if (this.isAddressSameAsShipping() && !this.isBillingBeforeShipping()) {
                        ...
                        window.checkoutConfig.onestepcheckout.uncheckBillingAddressIsSameShippingAddress = false;
                        ...
                        window.checkoutConfig.onestepcheckout.uncheckBillingAddressIsSameShippingAddress = true;
                    }
