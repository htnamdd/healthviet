...
define(
    ...
    function (
        ...
        return Component.extend({
            ...
            placeOrder: function () {
                var _this = this;
                // Prioritize billing address form in case billing is not same as shipping address
                if (window.checkoutConfig.onestepcheckout.uncheckBillingAddressIsSameShippingAddress) {
