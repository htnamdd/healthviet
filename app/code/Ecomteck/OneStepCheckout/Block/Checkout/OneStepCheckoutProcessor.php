    ...
    private function moveBillingAddress($jsLayout)
    {
        if (isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ...
            $billingFields['district_id'] = [
                ...
                'dataScope' => 'billingAddress.custom_attributes.district_id',
                ...
                'source' => 'billingAddress.custom_attributes.district_id',
                'imports' => [
            ...
            $billingFields['district'] = [
                ...
                'dataScope' => 'billingAddress.custom_attributes.district',
                'source' => 'billingAddress.custom_attributes.district',
                'label' => __('District'),
                'provider' => 'checkoutProvider',
                'validation' => [
                    'required-entry' => true,
            ...
            $billingFields['ward_id'] = [
                ...
                'dataScope' => 'billingAddress.custom_attributes.ward_id',
                'provider' => 'checkoutProvider',
                'label' => __('Ward'),
                'visible' => true,
                'validation' => [
                ...
                'source' => 'billingAddress.custom_attributes.ward_id',
                'imports' => [
            ...
            $billingFields['ward'] = [
                ...
                'dataScope' => 'billingAddress.custom_attributes.ward',
                'source' => 'billingAddress.custom_attributes.ward',
                'label' => __('Ward'),
                'provider' => 'checkoutProvider',
                'validation' => [
                    'required-entry' => true,
            ...
            $billingFields['city']['visible'] = 0;
            $billingFields['postcode']['visible'] = 0;
            $billingFields['street']['children'][1]['visible'] = 0;
            $billingFields['country_id']['visible'] = 0;
            $billingFields['telephone']['validation']['validate-number'] = true;
            $billingFields['telephone']['validation']['validate-exact-length'] = 10;
        }
